...
export default function LockUserModal({ user, onClose, onSuccess }) {
  ...
  return (
    ...
    >
      <div className="max-h-[100dvh] w-full max-w-md overflow-y-auto rounded-t-2xl border border-rose-800/60 bg-slate-900 pb-[env(safe-area-inset-bottom)] shadow-2xl sm:max-h-[92dvh] sm:rounded-2xl">
